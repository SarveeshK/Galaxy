  ...
  return (
    <div className="relative min-h-screen bg-black overflow-x-hidden">
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="fixed top-6 right-24 z-50 w-12 h-12 rounded-full glass flex items-center justify-center hover:bg-white/10 transition-all border border-white/10 hover:border-white/30 group"
        title="Go to Top"
      >
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="fixed top-6 right-6 z-50 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center shadow-lg hover:bg-white/20 transition-all hover:scale-110"
        title="Galaxy 2K26"
      >
