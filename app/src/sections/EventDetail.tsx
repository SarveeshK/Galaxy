    ...
    <div className="relative min-h-screen pt-20 pb-24 md:py-20 px-4 overflow-x-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="mb-8 flex items-center gap-2 px-4 py-2 rounded-full glass text-white/70 hover:text-white hover:bg-white/10 transition-all border border-white/10 hover:border-white/30 sticky top-4 md:static z-50 backdrop-blur-md bg-black/20"
        >
